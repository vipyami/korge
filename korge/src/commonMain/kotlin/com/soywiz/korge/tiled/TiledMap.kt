...
fun TiledMap.Layer.Objects.Object.getPos(map: TiledMapData): Point =
	Point(bounds.x / map.tilewidth, bounds.y / map.tileheight)

fun TiledMapData?.getObjectPosByName(name: String): Point? {
